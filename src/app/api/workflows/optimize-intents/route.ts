...
export async function POST(req: NextRequest) {
  try {
    ...
    console.log(`[Workflow] Iniciando otimização de intenções para tenant: ${user.id}`);
    
    const scriptPath = "/home/ubuntu/daily_optimizer.py";
    ...
    try {
      ...
      return NextResponse.json({
        success: true,
        message: "Intenções otimizadas com sucesso!",
